...
const Footer = () => {
  return (
    <footer
      className="bg-slate-700 text-slate-200 text-sm
  mt-16"
    >
      <Container>
        <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <p className="mb-2 ">
              ...
              officia animi at deserunt dolore sed dolorum eum sint, maiores
              architecto ut vero voluptatibus cum culpa, deleniti doloribus
              voluptatem hic! Harum!
            </p>
